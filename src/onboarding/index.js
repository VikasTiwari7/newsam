...

                    {
                        currentPage != data.length - 1 ? (
                            <TouchableOpacity
                                ...
                                activeOpacity={0.8}
                            >
                                <Image source={Path.Routing} style={{ height: 20, width: 20, alignSelf: 'center' }}></Image>
                            </TouchableOpacity>
                        ) : (
                            // Get Started Button
                            <TouchableOpacity style={{
                                ...
                                <Image source={Path.Routing} style={{ height: 20, width: 20 }}></Image>
                            </TouchableOpacity>
                        )
                    }
                </View>
        ...
        return (
            <View style={{
                ...
                <View style={{ paddingHorizontal: SIZES.base * 4, marginVertical: SIZES.base * 4 }}>
                    ...
                    <Text style={{ fontSize: 17, textAlign: 'center' }}>{item.subtitle}</Text>
                    <Text style={{
                        fontSize: 15,
                        opacity: 0.4,
                        textAlign: 'center',
